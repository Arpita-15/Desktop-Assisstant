        ...
        if(password=="arpita")
        {
            ...
            do{
                ...
                else if(command=="play music")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\\c++\\Project\\Reasons.mp3",NULL, NULL, SW_NORMAL);
                }
                ...
                else if(command=="open photo")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\\Users\\ASUS\\Dropbox\\PC\\Pictures\\Camera Roll",NULL, NULL, SW_NORMAL);
                }
